    ...
    <div className="crm-page-stack">
      <section className="flex flex-col justify-between gap-3 lg:flex-row lg:items-end">
        <div className="min-w-0">
          <p className="text-xs font-semibold uppercase tracking-wide text-crm-orange">Orders</p>
          <h1 className="mt-1 text-xl font-semibold text-crm-ink md:text-2xl">Sales orders</h1>
      ...
      <section className="rounded-lg border border-crm-line bg-white shadow-sm">
        <div className="flex flex-col gap-2 border-b border-crm-line px-3.5 py-2.5 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-semibold text-crm-ink">All orders</h2>
        ...
        {isLoading ? (
          ...
          <div className="crm-table-empty">
            ...
            <h3 className="mt-3 text-sm font-semibold text-crm-ink">No orders found</h3>
          ...
          <div className="crm-table-shell">
            <table className="crm-table min-w-[1040px] w-full text-left">
              <thead>
                <tr>
              ...
              <tbody>
                {table.rows.map((order) => (
                  <tr key={order.id}>
                    ...
                    <td className="text-crm-muted">{getCustomerLabel(order.customer_id)}</td>
                    <td className="text-crm-muted">{formatDate(order.order_date)}</td>
                    <td className="text-crm-muted">{formatMoney(order.total_amount)}</td>
                    <td>
                      <StatusBadge status={order.status} />
                    </td>
                    <td className="text-crm-muted">{formatDate(order.created_at)}</td>
                    <td>
